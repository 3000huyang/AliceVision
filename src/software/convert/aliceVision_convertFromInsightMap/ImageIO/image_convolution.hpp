...
#ifndef INSIGHT_IMAGE_IMAGE_CONVOLUTION_HPP_
#define INSIGHT_IMAGE_IMAGE_CONVOLUTION_HPP_
                                ...
                                Image<float> & out)
{
  ...
  typedef Eigen::Matrix<typename INSIGHT::Accumulator<pix_t>::Type, Eigen::Dynamic, 1> VecKernel;
  const VecKernel horiz_k_cast = horiz_k.template cast< typename INSIGHT::Accumulator<pix_t>::Type >();
  const VecKernel vert_k_cast = vert_k.template cast< typename INSIGHT::Accumulator<pix_t>::Type >();
...
#endif // INSIGHT_IMAGE_IMAGE_CONVOLUTION_HPP_
