...
#include "INSIGHT/image/image.hpp"
#include "testing/testing.h"

using namespace INSIGHT;
using namespace INSIGHT::image;
using std::string;
...
TEST(GetFormat, filenames) {
  EXPECT_EQ(GetFormat("something.jpg"), INSIGHT::image::Jpg);
  EXPECT_EQ(GetFormat("something.png"), INSIGHT::image::Png);
  EXPECT_EQ(GetFormat("something.pnm"), INSIGHT::image::Pnm);
  EXPECT_EQ(GetFormat("something.tif"), INSIGHT::image::Tiff);
  EXPECT_EQ(GetFormat("/some/thing.JpG"), INSIGHT::image::Jpg);
  EXPECT_EQ(GetFormat("/some/thing.pNG"), INSIGHT::image::Png);
  EXPECT_EQ(GetFormat("some/thing.PNm"), INSIGHT::image::Pnm);
  EXPECT_EQ(GetFormat("some/thing.TIf"), INSIGHT::image::Tiff);
  EXPECT_EQ(GetFormat(".s/o.m/e.t/h.i/n.g.JPG"), INSIGHT::image::Jpg);
  EXPECT_EQ(GetFormat(".s/o.m/e.t/h.i/n.g.PNG"), INSIGHT::image::Png);
  EXPECT_EQ(GetFormat(".s/o.m/e.t/h.i/n.g.PNM"), INSIGHT::image::Pnm);
  EXPECT_EQ(GetFormat(".s/o.m/e.t/h.i/n.g.TIF"), INSIGHT::image::Tiff);
}
